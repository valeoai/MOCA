"""
Mostly copy-pasted and adapted from the MAE[*] code: https://github.com/facebookresearch/mae
...
def get_args_parser():
    ...
    parser.add_argument('--drop_path', type=float, default=0.2, metavar='PCT',
                        help='Drop path rate (ibot default: 0.2)')
    ...
    parser.add_argument('--layer_decay', type=float, default=0.65,
                        help='layer-wise lr decay from ELECTRA/BEiT (ibot default: 0.65)')
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/datasets_local/ImageNet/', type=str,
                        help='dataset path')
...
def main(args):
    ...
    if (args.subset is not None) and (args.subset >= 1):
        dataset_train = data_utils.subset_of_ImageNet_train_split(dataset_train, args.subset)
    ...
    if args.finetune and not args.eval:
        load_pretrained_encoder(model, args.finetune, 
            use_teacher=args.use_teacher, avg_pooling=args.global_pool,
            use_fc_norm=args.use_fc_norm, no_linear_head=False)
